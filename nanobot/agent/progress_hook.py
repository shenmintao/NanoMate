...
class AgentProgressHook(AgentHook):
    ...
    def __init__(
        ...
        *,
        ...
        response_filter_tags: list[str] | None = None,
        ...
        self._response_filter_tags = response_filter_tags or []
    ...
    def _strip_think(self, text: str | None) -> str | None:
        if not text:
            return None
        return strip_think(text, self._response_filter_tags) or None
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        prev_clean = strip_think(self._stream_buf, self._response_filter_tags)
        self._stream_buf += delta
        new_clean = strip_think(self._stream_buf, self._response_filter_tags)
